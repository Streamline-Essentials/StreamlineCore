package net.streamline.api.base.events;
 ...
 *
 * @see net.streamline.api.base.modules.ModuleManager#callEvent(Event)
 * @see net.streamline.api.base.modules.ModuleManager#registerEvents(Listener,Plugin)
 */
