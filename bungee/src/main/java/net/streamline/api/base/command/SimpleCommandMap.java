...
public class SimpleCommandMap implements CommandMap {
    ...
    public SimpleCommandMap(@NotNull final BasePlugin server) {
        this.server = server;
        setDefaultCommands();
    }
...
//        register("bukkit", new ModulesCommand("Modules"));
...
//        register("bukkit", new HelpCommand());
    ...
    private synchronized boolean register(@NotNull String label, @NotNull Command command, boolean isAlias, @NotNull String fallbackPrefix) {
        ...
        if ((command instanceof ModuleCommand || isAlias) && knownCommands.containsKey(label)) {
     ...
     */
    @Override
    public boolean dispatch(@NotNull CommandExecutor sender, @NotNull String commandLine) throws CommandException {
    ...
    @Override
    @Nullable
    public List<String> tabComplete(@NotNull CommandExecutor sender, @NotNull String cmdLine) {
        ...
        if (spaceIndex == -1) {
            ...
            final String prefix = (sender instanceof ProxiedPlayer ? "/" : "");
