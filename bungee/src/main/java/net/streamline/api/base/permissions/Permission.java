...
public class Permission {
    ...
    public Set<Permissible> getPermissibles() {
        return Streamline.getInstance().getModuleManager().getPermissionSubscriptions(name);
    }
    ...
    public void recalculatePermissibles() {
        ...
        Streamline.getInstance().getModuleManager().recalculatePermissionDefaults(this);
    ...
    public Permission addParent(@NotNull String name, boolean value) {
        ModuleManager pm = Streamline.getInstance().getModuleManager();
    ...
    public static List<Permission> loadPermissions(@NotNull Map<?, ?> data, @NotNull String error, @Nullable PermissionDefault def) {
        ...
        for (Map.Entry<?, ?> entry : data.entrySet()) {
            try {
                ...
                Streamline.getInstance().getLogger().log(Level.SEVERE, String.format(error, entry.getKey()), ex);
            }
        }
