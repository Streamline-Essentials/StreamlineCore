...
import net.streamline.api.base.command.ConsoleCommandSender;
import net.streamline.api.base.command.ModuleCommand;
import net.streamline.api.base.entities.Player;
import net.streamline.api.base.help.HelpMap;
import net.streamline.api.base.modules.ModuleManager;
...
public interface IPlugin {
    ...
    /**
     * Gets the Bukkit version that this plugin is running.
     *
...
//    public Server createServer(@NotNull ServerCreator creator);
     ...
     */
    public boolean dispatchCommand(@NotNull CommandExecutor sender, @NotNull String commandLine) throws CommandException;
