...
import net.streamline.api.base.command.ModuleCommandYamlParser;
import net.streamline.api.base.command.SimpleCommandMap;
import net.streamline.api.base.configs.StorageUtils;
import net.streamline.api.base.events.Event;
import net.streamline.api.base.events.EventPriority;
import net.streamline.api.base.events.HandlerList;
import net.streamline.api.base.events.Listener;
import net.streamline.api.base.permissions.Permissible;
import net.streamline.api.base.permissions.Permission;
import net.streamline.api.base.permissions.PermissionDefault;
...
//    private MutableGraph<String> dependencyGraph = GraphBuilder.directed().build();
    ...
    public Module[] loadModules(@NotNull File directory) {
        ...
        if (! (BasePlugin.getUpdateFolder() == null)) {
            updateDirectory = BasePlugin.getUpdateFolder();
        }
