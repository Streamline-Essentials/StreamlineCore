package net.streamline.api.base.entities;

import net.streamline.api.base.command.CommandSender;
...
//    public void stopAllSounds();
     ...
     * @deprecated see {@link #hidePlayer(Module, Player)}
     */
    @Deprecated
     ...
     * @param player Player to hide
     */
    public void hidePlayer(@NotNull Module module, @NotNull Player player);

    /**
     * Allows this player to see a player that was previously hidden
     *
     * @param player Player to show
     * @deprecated see {@link #showPlayer(Module, Player)}
     */
    @Deprecated
     ...
     * @param player Player to show
     */
    public void showPlayer(@NotNull Module module, @NotNull Player player);
