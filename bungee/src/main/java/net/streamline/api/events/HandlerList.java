...
public class HandlerList {
     ...
     */
    public static void unregisterAll(@NotNull StreamlineModule module) {
        synchronized (allLists) {
            for (HandlerList h : allLists) {
                h.unregister(module);
            }
     ...
     */
    public static void unregisterAll(@NotNull StreamlineListener listener) {
        synchronized (allLists) {
            for (HandlerList h : allLists) {
     ...
     *
     * @param module plugin to remove
     */
    public synchronized void unregister(@NotNull StreamlineModule module) {
     ...
     * @param listener listener to remove
     */
    public synchronized void unregister(@NotNull StreamlineListener listener) {
        boolean changed = false;
        for (List<RegisteredListener> list : handlerslots.values()) {
            for (ListIterator<RegisteredListener> i = list.listIterator(); i.hasNext();) {
     ...
     */
    @NotNull
    public static ArrayList<RegisteredListener> getRegisteredListeners(@NotNull StreamlineModule module) {
