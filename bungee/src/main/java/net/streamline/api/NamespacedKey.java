...
public final class NamespacedKey {
     ...
     * underscores, hyphens, and forward slashes.
     *
     * @param module the module to use for the namespace
     * @param key the key to create
     */
    public NamespacedKey(@NotNull Module module, @NotNull String key) {
        Preconditions.checkArgument(module != null, "Module cannot be null");
        Preconditions.checkArgument(key != null, "Key cannot be null");

        this.namespace = module.getName().toLowerCase(Locale.ROOT);
     ...
     * <pre>
     * fromString("foo", module) -{@literal >} "module:foo"
     * fromString("foo:bar", module) -{@literal >} "foo:bar"
     * fromString(":foo", null) -{@literal >} "minecraft:foo"
     * fromString("foo", null) -{@literal >} "minecraft:foo"
     * fromString("Foo", module) -{@literal >} null
     * fromString(":Foo", module) -{@literal >} null
     * fromString("foo:bar:bazz", module) -{@literal >} null
     * fromString("", module) -{@literal >} null
     * </pre>
     *
     ...
     */
    @Nullable
    public static NamespacedKey fromString(@NotNull String string, @Nullable Module defaultNamespace) {
