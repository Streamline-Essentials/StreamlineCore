...
public class PingedResponse {
    ...
    {
        this( version, players, description, favicon == null ? null : StreamlineFavicon.create(favicon));
    }

    public PingedResponse(Protocol version, Players players, String description, StreamlineFavicon favicon)
    {
    ...
    {
        setFavicon(favicon == null ? null : StreamlineFavicon.create( favicon ) );
    }
}
